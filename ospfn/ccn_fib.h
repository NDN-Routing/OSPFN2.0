...
extern void init_data(struct ccn_charbuf *local_scope_template);
extern int get_ccndid(struct ccn *h, struct ccn_charbuf *local_scope_template,unsigned char *ccndid);

...
/**
 * Add a ccn face for a name prefix
 *
 */

int 
add_ccn_face(struct ccn *h, const char *uri, const char *address, const unsigned int p)
{
...
/**
 * Delete a ccn face for a name prefix
 *
 */

int 
delete_ccn_face(struct ccn *h, const char *uri, const char *address, const unsigned int p)
{

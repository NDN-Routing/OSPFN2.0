...
extern int ospf_apiserver_handle_sync_lsdb (struct ospf_apiserver *apiserv,
				     struct msg *msg);
/* 08/25/2011 yic+ */
extern int ospf_apiserver_handle_get_router_nexthops_request(struct ospf_apiserver *apiserv,
				     struct msg *msg);
...
/* 08/23/2011 yic +1 */
extern void ospf_apiserver_notify_router_routing_table_change(struct in_addr router_id, struct route_node *rn);
